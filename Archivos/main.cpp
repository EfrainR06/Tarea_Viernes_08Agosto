//Efrain Retana Segura & Daniel Villorreal UNA
#include "archivo.h"
#include <stdio.h>
...
int main() {
    ...
    imprimirLista("1group.bin");
    imprimirLista("2group.bin");
    imprimirCursos("cursos.bin");


    organizarArchivosEfra("1group.bin","2group.bin");
    printf("\nDespues de ordenar por notas: ");
    imprimirLista("Combinado.bin");
    return 0;
}